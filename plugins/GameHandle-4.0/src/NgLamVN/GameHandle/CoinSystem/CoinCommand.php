...
class CoinCommand extends Command implements PluginOwned
{
    ...
    public function __construct(CoinSystem $system)
    {
        $this->system = $system;
    ...
    public function Fpay(Player $player)
    {
        $form = new CustomForm(function (Player $player, $data)
        {
            ...
            $taget = Server::getInstance()->getPlayerByPrefix($data[0]);
            if ($taget == null)
            {
                $taget = $data[0];
