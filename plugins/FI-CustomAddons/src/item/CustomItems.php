...
use CustomAddons\item\armor\BoosterBoots;
use CustomAddons\item\armor\MagmaBoots;
use CustomAddons\item\armor\SlimeBoots;
use CustomAddons\item\fishingrod\AncientRod;
use CustomAddons\item\fishingrod\auto\MechanicalRod;
use CustomAddons\item\fishingrod\auto\OpAutomationRod;
use CustomAddons\item\fishingrod\FiberglassRod;
use CustomAddons\item\fishingrod\GrapplingHook;
use CustomAddons\item\fishingrod\OpRod;
use CustomAddons\item\fishingrod\RodOfChallenging;
use CustomAddons\item\fishingrod\RodOfChampions;
use CustomAddons\item\fishingrod\RodOfLegends;
use CustomAddons\item\fishingrod\RodOfTheSea;
use CustomAddons\item\fishingrod\StarterRod;
use CustomAddons\item\utils\Rarity;
use InvalidArgumentException;
use pocketmine\block\VanillaBlocks;
use pocketmine\item\VanillaItems;
use CustomAddons\item\CustomItemNamespaceIds as CustomItemIds;
