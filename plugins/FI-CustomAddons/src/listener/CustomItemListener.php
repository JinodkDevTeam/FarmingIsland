...
class CustomItemListener implements Listener{
	 ...
	 * @priority LOWEST
	 * @description Handle onSneak event for CustomAddons
	 * @handleCancelled FALSE
	 */
