...
SELECT
    ...
    ForagingLevel,
    ForagingExp
FROM Skill WHERE Player=:player;
-- #    }
-- #    { register
-- #        :player string
-- #        :mininglevel int
...
-- #    { unregister
-- #        :player string
DELETE FROM Skill WHERE Player=:player;
-- #    }
-- #    { update
-- #        { mining
-- #            { level
-- #                :player string
-- #                :level int
UPDATE Skill SET MiningLevel=:level WHERE Player=:player;
-- #            }
-- #            { exp
-- #                :player string
-- #                :exp int
...
-- #                :player string
-- #                :level int
UPDATE Skill SET FishingLevel=:level WHERE Player=:player;
-- #            }
-- #            { exp
-- #                :player string
-- #                :exp int
...
-- #                :player string
-- #                :level int
UPDATE Skill SET FarmingLevel=:level WHERE Player=:player;
-- #            }
-- #            { exp
-- #                :player string
-- #                :exp int
...
-- #                :player string
-- #                :level int
UPDATE Skill SET ForagingLevel=:level WHERE Player=:player;
-- #            }
-- #            { exp
-- #                :player string
-- #                :exp int
