...
class CustomItemFactory{
	...
	public function __construct(){
		...
		$this->register(new EnchantedItem(new CustomItemIdentifier(CustomItemIds::ENCHANTED_DARK_OAK_WOOD), "Enchanted Dark Oak Wood", Rarity::COMMON(), VanillaBlocks::DARK_OAK_WOOD()->asItem()));		$this->register(new RefinedItem(new CustomItemIdentifier(CustomItemIds::REFINED_IRON), "Refined Iron", Rarity::RARE(), VanillaItems::LIGHT_GRAY_DYE()));
